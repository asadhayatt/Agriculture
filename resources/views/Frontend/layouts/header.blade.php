  ...
  <div class="row top_1">
   ...
   <div class="col-md-3">
    <div class="top_1m text-center">
	  <h3 class="mb-0" style="line-height:0.6em;"><a class="text-black" href="{{url('/index')}}"><span style="margin-bottom:10px;" class="d-inline-block"><i class="fa fa-leaf col_1"></i></span> <br>AGRIGOAL <span class="col_2 font_16 normal">AGRICULTURE FARM</span></a></h3>
	</div>
   </div>
   <div class="col-md-4">
...
<nav class="navbar navbar-expand-md  navbar-center navbar-light" id="navbar_sticky">
  <div class="container">
    <a class="navbar-brand col_1" href="{{url('/index')}}"><span style="margin-bottom:10px;" class="d-inline-block"><i class="fa fa-leaf col_1"></i></span> 
