     ...
     <div class="row footer_1">
	  ...
	  <div class="footer_1i2 clearfix">
	   ...
	   <div class="footer_1i2i clearfix">
	     <img src="{{url('Frontend/img/8.jpg')}}" alt="abc" height="90" width="90">
	   <p class="col_3">We have been offering afford able upbringing.<br>
<span class="col_2">May 26, 2019</span></p>
	   </div>
	   <div class="footer_1i2i clearfix">
	     <img src="{{url('Frontend/img/6.jpg')}}" alt="abc" height="90" width="90">
	   <p class="col_3">We have been offering afford able upbringing.<br>
<span class="col_2">May 26, 2019</span></p>
	   </div>
	   <div class="footer_1i2i clearfix">
	     <img src="{{url('Frontend/img/7.jpg')}}" alt="abc" height="90" width="90">
	   <p class="col_3">We have been offering afford able upbringing.<br>
<span class="col_2">May 26, 2019</span></p>
	   </div>
	  </div>
...
<section id="footer_bm">
 <div class="container">
  <div class="footer_2 row">
   <div class="col-md-8">
    <div class="footer_2l">
	  <p class="mb-0 col_3">© 2013 Your Website Name. All Rights Reserved | Design by <a class="col_4" href="http://www.templateonweb.com">TemplateOnWeb</a></p>
	</div>
   </div>
   <div class="col-md-4">
